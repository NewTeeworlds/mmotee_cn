...
#ifndef GAME_SERVER_ENTITIES_BOT_BOSSCLEANER_H
#define GAME_SERVER_ENTITIES_BOT_BOSSCLEANER_H
...
class CBossCleaner : public CCharacter
{
	MACRO_ALLOC_POOL_ID()
...
public:
	...
	CBossCleaner(CGameWorld *pWorld, int MapID);
