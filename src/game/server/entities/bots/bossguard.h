...
#ifndef GAME_SERVER_ENTITIES_BOT_BOSSGUARD_H
#define GAME_SERVER_ENTITIES_BOT_BOSSGUARD_H
...
class CBossGuard : public CCharacter
{
	MACRO_ALLOC_POOL_ID()
...
public:
	...
	CBossGuard(CGameWorld *pWorld, int MapID);
