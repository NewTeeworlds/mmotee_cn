...
#ifndef GAME_SERVER_ENTITIES_BOT_BOSSSLIME_H
#define GAME_SERVER_ENTITIES_BOT_BOSSSLIME_H
...
class CBossSlime : public CCharacter
{
	MACRO_ALLOC_POOL_ID()
...
public:
	...
	CBossSlime(CGameWorld *pWorld, int MapID);
