...
(155,6,'龙镐','- 用于挖矿'),
(156,5,'核心基座','- 用于合成核心'),
(157,1,'神器-繁林核心','- 单次伐木进度+75%'),
(158,1,'神器-髓岩核心','- 挖矿时补偿龙矿');
...
(145,10,'Title WorkerM','- 挖矿所得增加100%'),
(146,10,'Title FarmerF','- 种地速度提升100%'),
(147,10,'Title FarmerM','- 种地所得增加100%'),
(148,10,'Title Manual','- 合成成功率提升20%'),
(149,10,'Title P.P.P.','- 打怪爆率提升30%'),
(150,10,'Title T.G.P.C.R.','- 杀人不增加愤怒值'),
