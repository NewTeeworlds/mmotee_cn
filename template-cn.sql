...
(144,12,'称号-工人爷爷','- 挖矿速度提升100%'),
(145,12,'称号-工人奶奶','- 挖矿所得增加100%'),
(146,12,'称号-农民爷爷','- 种地速度提升100%'),
(147,12,'称号-农民奶奶','- 种地所得增加100%'),
(148,12,'称号-手工业','- 合成成功率提升20%'),
(149,12,'称号-公私合营','- 打怪爆率提升30%'),
(150,12,'称号-文革','- 杀人不增加愤怒值'),
(151,12,'称号-人民公社','- 吃菜获得经验*1.5'),
(152,12,'称号-大跃进','- 移速增加，具有"浮夸风"'),
...
(144,12,'Title WorkerF','- 挖矿速度提升100%'),
(145,12,'Title WorkerM','- 挖矿所得增加100%'),
(146,12,'Title FarmerF','- 种地速度提升100%'),
(147,12,'Title FarmerM','- 种地所得增加100%'),
(148,12,'Title Manual','- 合成成功率提升20%'),
(149,12,'Title P.P.P.','- 打怪爆率提升30%'),
(150,12,'Title T.G.P.C.R.','- 杀人不增加愤怒值'),
(151,12,'Title People Commune','- 吃菜获得经验*1.5'),
(152,12,'Title G.L.F.','- 移速增加，具有"浮夸风"'),
